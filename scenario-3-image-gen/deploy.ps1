...
# Deploys to a GPU workload profile for Stable Diffusion inference.
...
Write-Host "The container will run on a GPU workload profile for Stable Diffusion inference." -ForegroundColor DarkGray
Write-Host ""

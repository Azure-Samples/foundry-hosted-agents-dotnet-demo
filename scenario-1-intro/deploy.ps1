...
if (-not (Test-Path "scenario-1-intro/src/HostedAgent/Dockerfile")) {
    Write-Host "❌ scenario-1-intro/src/HostedAgent/Dockerfile not found. The agent code must be created first." -ForegroundColor Red
    exit 1
}
